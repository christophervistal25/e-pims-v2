    ...
    $('#salaryGradeForm').submit(function (e) {
        ...
        $.ajax({
            ...
            success: function (response) {
                if(response.success){
                    $('input').val('');
                    const select = [ "#sgNo", "#sgYear" ]; 
                    $.each(select, function(index , value) {
                    $(`${value}`).val('Please Select').trigger('change');
                    });
                    const errorClass = [ "#sgNo", "#sgStep1", "#sgStep2", "#sgStep3", "#sgStep4", "#sgStep5", "#sgStep6", "#sgStep7", "#sgStep8", "#sgYear"];
                    $.each(errorClass, function(index , value) {
                        $(`${value}`).removeClass('is-invalid');
                        });
                    const errorMessage = ["#salary-grade-error-message","#salary-grade1-error-message","#salary-grade2-error-message","#salary-grade3-error-message","#salary-grade4-error-message","#salary-grade5-error-message","#salary-grade6-error-message","#salary-grade7-error-message","#salary-grade8-error-message","#salary-grade-year-error-message"];
            ...
            error: function (response) {
                    if( response.status === 422 ) {
                        ...
                        if(errors.hasOwnProperty('sgNo')) {
                            ...
                            $('#salary-grade-error-message').append(`<span>${errors.sgNo[0]}</span>`);
                        }else{
                        ...
                        if(errors.hasOwnProperty('sgStep1')) {
                            ...
                            $('#salary-grade1-error-message').append(`<span>${errors.sgStep1[0]}</span>`);
                        }else{
                        ...
                        if(errors.hasOwnProperty('sgStep2')) {
                            ...
                            $('#salary-grade2-error-message').append(`<span>${errors.sgStep2[0]}</span>`);
                        }else{
                        ...
                        if(errors.hasOwnProperty('sgStep3')) {
                            ...
                            $('#salary-grade3-error-message').append(`<span>${errors.sgStep3[0]}</span>`);
                        }else{
                        ...
                        if(errors.hasOwnProperty('sgStep4')) {
                            ...
                            $('#salary-grade4-error-message').append(`<span>${errors.sgStep4[0]}</span>`);
                        }else{
                        ...
                        if(errors.hasOwnProperty('sgStep5')) {
                            ...
                            $('#salary-grade5-error-message').append(`<span>${errors.sgStep5[0]}</span>`);
                        }else{
                        ...
                        if(errors.hasOwnProperty('sgStep6')) {
                            ...
                            $('#salary-grade6-error-message').append(`<span>${errors.sgStep6[0]}</span>`);
                        }else{
                        ...
                        if(errors.hasOwnProperty('sgStep7')) {
                            ...
                            $('#salary-grade7-error-message').append(`<span>${errors.sgStep7[0]}</span>`);
                        }else{
                        ...
                        if(errors.hasOwnProperty('sgStep8')) {
                            ...
                            $('#salary-grade8-error-message').append(`<span>${errors.sgStep8[0]}</span>`);
                        }else{
                        ...
                        if(errors.hasOwnProperty('sgYear')) {
                            ...
                            $('#salary-grade-year-error-message').append(`<span>${errors.sgYear[0]}</span>`);
                        }else{
