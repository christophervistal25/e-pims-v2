...
$(document).ready(function () {
    let errorClass = [".sgNo .dropdown", "#sgStep1", "#sgStep2", "#sgStep3", "#sgStep4", "#sgStep5", "#sgStep6", "#sgStep7", "#sgStep8", ".sgYear .dropdown"];
    let errorMessage = ["#salary-grade-error-message", "#salary-grade1-error-message", "#salary-grade2-error-message", "#salary-grade3-error-message", "#salary-grade4-error-message", "#salary-grade5-error-message", "#salary-grade6-error-message", "#salary-grade7-error-message", "#salary-grade8-error-message", "#salary-grade-year-error-message"];
    let select = ["#sgNo"];
