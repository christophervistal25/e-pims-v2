...
$(document).ready(function () {
        ...
        let salaryAdjustmentPerOfficeSelected = $("#salaryAdjustmentPerOffice").DataTable();
        let salaryAdjustmentPerOfficeNotSelected = $("#salaryAdjustmentPerOfficeList").DataTable();
        ...
        $("#employeeOffice").change(function(e) {
            ...
            let plantilla = $("#employeeOffice option:selected")[FIRST_ELEMENT_OF_SELECT].getAttribute('data-plantilla');
            $('#officeAdjustment').html(plantilla || '');


            if(employeeOffice) {
                salaryAdjustmentPerOfficeSelected.destroy();
                salaryAdjustmentPerOfficeSelected = $("#salaryAdjustmentPerOffice").DataTable({
                            processing: true,
                            serverSide: true,
                            destroy: true,
                            retrieve: true,
                ...
                salaryAdjustmentPerOfficeNotSelected = $("#salaryAdjustmentPerOfficeList").DataTable({
                    processing: true,
                    serverSide: true,
                    destroy: true,
                    retrieve: true,
                    ...
                    columns: [
                        ...
                        {
                            data: "plantilla.position.position_name",
                            name: "position_name",
                            defaultContent : '',
                        },
                        {
        ...
        $("#selectAll").click(function(e) {
            ...
            let rows = salaryAdjustmentPerOfficeNotSelected.rows({ search: "applied" }).nodes();
