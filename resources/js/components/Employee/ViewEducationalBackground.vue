<template>
    <div class="card">
        <div v-if="employee.educational_background" class="card-body ">
            <div class="pl-3 pr-3">
                <div
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="form-group">
                        <label>
                            vocational trade course highest level units earned
                            :</label
                        >
                        <input
                            type="text"
        ...
        <div v-else class="card-body">
            <h1>No Educational Background</h1>
        </div>
    </div>
</template>
