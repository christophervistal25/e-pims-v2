                ...
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs nav-tabs-bottom">
                        ...
                        <li class="nav-item">
                            <a
                                class="nav-link"
                                href="#educational-background-tab"
                                data-toggle="tab"
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <a
                                    class="dropdown-item"
                                    href="#civil-service-tab"
                                    data-toggle="tab"
                                    >Civil Service Egibility</a
                                >
                                <a
                                    class="dropdown-item"
                                    href="#learning-and-development-tab"
                                    data-toggle="tab"
                                    >Learning and Development</a
                                >
                                <a
                                    class="dropdown-item"
                                    href="#other-information-tab"
                                    data-toggle="tab"
                                    >Other Information</a
                                >
                                <a
                                    class="dropdown-item"
                                    href="#relevant-queries-tab"
                                    data-toggle="tab"
                                    >Relevant Queries</a
                                >
                                <a
