    ...
    <div>
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0 p-2">RELEVANT QUERIES</h5>
            </div>
                            ...
                            <td @click="markYes('question_34_a')">
                                <div class="form-check">
                                    <input
                                        ...
                                        v-model="
                                            relevantQueries.question_34_a_answer
                                        "
                                    />
                                    <label
                                        for="yes_34_a"
                            ...
                            <td class="" @click="markYes('question_34_b')">
                                <div class="form-check">
                                    <input
                                        ...
                                        value="yes"
                                        v-model="
                                            relevantQueries.question_34_b_answer
                                        "
                                    />
                                    <label
                                        class="form-check-label pr-2"
                            ...
                            <td v-on:click="markYes('question_35_a')">
                                <div class="form-check">
                                    <input
                                        ...
                                        class="form-check-input"
                                        v-model="
                                            relevantQueries.question_35_a_answer
                                        "
                                        value="yes"
                                        id="yes_35_a"
                                    />
                            ...
                            >
                                <div class="form-check">
                                    <input
                                        ...
                                        class="form-check-input"
                                        v-model="
                                            relevantQueries.question_35_b_answer
                                        "
                                        value="yes"
                                    />
                                    <label
                            ...
                            <td class="w-25">
                                <div class="form-check">
                                    ...
                                    <input
                                        ...
                                        "
                                        v-model="
                                            relevantQueries.question_35_b_date_filled
                                        "
                                    />
                                    <input
                                        type="text"
                                        ...
                                        "
                                        v-model="
                                            relevantQueries.question_35_b_status_of_cases
                                        "
                                    />
                                </div>
                            </td>
                            ...
                            <td class="" v-on:click="markYes('question_36_a')">
                                <div class="form-check">
                                    <input
                                        ...
                                        class="form-check-input"
                                        v-model="
                                            relevantQueries.question_36_a_answer
                                        "
                                        value="yes"
                                    />
                                    <label
                            ...
                            <td class="" v-on:click="markYes('question_37_a')">
                                <div class="form-check">
                                    <input
                                        ...
                                        class="form-check-input"
                                        v-model="
                                            relevantQueries.question_37_a_answer
                                        "
                                        value="yes"
                                        id="yes_37"
                                    />
                            ...
                            <td class="" v-on:click="markYes('question_38_a')">
                                <div class="form-check">
                                    <input
                                        ...
                                        class="form-check-input"
                                        v-model="
                                            relevantQueries.question_38_a_answer
                                        "
                                        value="yes"
                                        id="yes_a_38"
                                    />
                            ...
                            <td class="" v-on:click="markYes('question_38_b')">
                                <div class="form-check">
                                    <input
                                        ...
                                        class="form-check-input"
                                        v-model="
                                            relevantQueries.question_38_b_answer
                                        "
                                        value="yes"
                                        id="yes_b_38"
                                    />
                            ...
                            <td v-on:click="markYes('question_39_a')">
                                <div class="form-check">
                                    <input
                                        ...
                                        class="form-check-input"
                                        v-model="
                                            relevantQueries.question_39_a_answer
                                        "
                                        value="yes"
                                        id="yes_39"
                                    />
                            ...
                            <td class="" v-on:click="markYes('question_40_a')">
                                <div class="form-check">
                                    <input
                                        ...
                                        class="form-check-input"
                                        v-model="
                                            relevantQueries.question_40_a_answer
                                        "
                                        value="yes"
                                        id="yes_a_40"
                                    />
                            ...
                            <td class="" v-on:click="markYes('question_40_b')">
                                <div class="form-check">
                                    <input
                                        ...
                                        class="form-check-input"
                                        v-model="
                                            relevantQueries.question_40_b_answer
                                        "
                                        value="yes"
                                        id="yes_b_40"
                                    />
                            ...
                            <td class="" v-on:click="markYes('question_40_c')">
                                <div class="form-check">
                                    <input
                                        ...
                                        id="yes_c_40"
                                        v-model="
                                            relevantQueries.question_40_c_answer
                                        "
                                        value="yes"
                                    />
                                    <label
...
export default {
    ...
    methods: {
        ...
        submit() {
            ...
            window.axios
                .post(
                    `/api/personal-data-sheet/relevant-queries/update/${this.employeeID}`,
    ...
    created() {
        window
            .axios(
                `/api/personal-data-sheet/relevant-queries/fetch/${this.employeeID}`
            )
            .then((response) => {
                if (response.status === 200 && response.data.length !== 0) {
                    this.relevantQueries = response.data;
                }
            });
    },
};
