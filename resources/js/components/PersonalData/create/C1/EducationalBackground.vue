    ...
    >
      ...
      <div class="pl-3 pr-3 pb-3">
        ...
        <div class="pr-3 pb-3 py-3">
          <div class="row">
            ...
            <div class="col-lg-2">
              <label class="form-group has-float-label" for="eyrGrad">
                <input
                  type="number"
                  id="eyrGrad"
                  class="form-control"
      ...
      <div class="pl-3 pr-3 pb-3">
        ...
        <div class="pr-3 pb-3 py-3">
          <div class="row">
            ...
            <div class="col-lg-2">
              <label class="form-group has-float-label" for="syrGrad">
                <input
                  type="number"
                  id="syrGrad"
                  class="form-control"
      ...
      <div class="pl-3 pr-3 pb-3">
        <div class="row">
          ...
          <div class="col-lg-2">
            <label class="form-group has-float-label" for="vyrGrad">
              <input
                type="number"
                id="vyrGrad"
                class="form-control"
      ...
      <div class="pl-3 pr-3 pb-3">
        <div class="row">
          ...
          <div class="col-lg-2">
            <label class="form-group has-float-label" for="cyrGrad">
              <input
                type="number"
                id="cyrGrad"
                class="form-control"
      ...
      <div class="pl-3 pr-3 pb-3">
        <div class="row">
          ...
          <div class="col-lg-2">
            <label class="form-group has-float-label" for="gyrGrad">
              <input
                type="number"
                id="gyrGrad"
                class="form-control"
