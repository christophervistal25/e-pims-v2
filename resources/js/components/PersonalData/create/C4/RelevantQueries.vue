                  ...
                  <input
                    ...
                    :class="
                      errors.hasOwnProperty('no_34_a_details')
                        ...
                        : ''
                    "
                    :readonly="relevantQueries.no_34_a !== 'yes'"
                    v-model="relevantQueries.no_34_a_details"
              ...
              <td class="w-25">
                <div class="form-check">
                  <input
                    ...
                    "
                    placeholder="If YES, then give details"
                    :readonly="relevantQueries.no_34_b !== 'yes'"
                    v-model="relevantQueries.no_34_b_details"
                  />
                </div>
              </td>
            </tr>
                  ...
                  <input
                    ...
                    :class="
                      errors.hasOwnProperty('no_35_a_details')
                        ...
                        : ''
                    "
                    :readonly="relevantQueries.no_35_a !== 'yes'"
                    v-model="relevantQueries.no_35_a_details"
                  />
                </div>
              </td>
            </tr>
              ...
              <td class="w-25">
                <div class="form-check">
                  <input
                    ...
                    "
                    :readonly="relevantQueries.no_36 !== 'yes'"
                    v-model="relevantQueries.no_36_details"
                  />
                </div>
              </td>
            </tr>
              ...
              <td class="w-25">
                <div class="form-check">
                  <input
                    ...
                    "
                    placeholder="If YES, then give details"
                    :readonly="relevantQueries.no_37 !== 'yes'"
                    v-model="relevantQueries.no_37_details"
                  />
                </div>
              </td>
            </tr>
              ...
              <td class="w-25">
                <div class="form-check">
                  <input
                    ...
                    "
                    placeholder="If YES, then give details"
                    :readonly="relevantQueries.no_38_a !== 'yes'"
                    v-model="relevantQueries.no_38_a_details"
                  />
                </div>
              </td>
            </tr>
                  ...
                  <input
                    ...
                    :class="
                      errors.hasOwnProperty('no_38_b_details')
                        ...
                        : ''
                    "
                    :readonly="relevantQueries.no_38_b !== 'yes'"
                    v-model="relevantQueries.no_38_b_details"
                  />
                </div>
              </td>
            </tr>
                  ...
                  <input
                    ...
                    :class="
                      errors.hasOwnProperty('no_40_a_details')
                        ...
                        : ''
                    "
                    :readonly="relevantQueries.no_40_a !== 'yes'"
                    v-model="relevantQueries.no_40_a_details"
                  />
                </div>
              </td>
            </tr>
                  ...
                  <input
                    ...
                    :class="
                      errors.hasOwnProperty('no_40_c_details')
                        ...
                        : ''
                    "
                    :readonly="relevantQueries.no_40_c !== 'yes'"
                    v-model="relevantQueries.no_40_c_details"
                  />
                </div>
              </td>
            </tr>
...
export default {
  ...
  methods: {
    ...
    submit() {
      ...
      window.axios
        .post("/employee/personal/relevant/queries", this.relevantQueries)
        .then((response) => {
  ...
  mounted() {
    if (localStorage.getItem("relevant_queries")) {
      this.relevantQueries = JSON.parse(
        localStorage.getItem("relevant_queries")
      );
      this.isComplete = true;
      this.$emit("display-reference");
    }
