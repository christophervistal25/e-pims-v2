            ...
            <div class="card shadow-none">
                ...
                <div class="card-body">
                    <img
                        ...
                        }}" width="20%" height="19%" class="border border-default float-right p-2 rounded cursor-pointer d-md-none d-lg-block" height="360px" />

                    <div class="row pb-0">
                        <div class="col-lg-12 pb-0">
                            <div class="form-group">
                                <label  class="h5 required">EMPLOYEE ID</label>
                                <input type="number" name="employeeID" radonly value="{{ $lastEmployeeID }}" class="form-control" />
                                <span class="text-sm text-danger" id='employeeID'></span>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 pb-0" >
                            <div class="form-group">
                                ...
                                <span class="text-sm text-danger" id='lastname'></span>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 pb-0">
                            <div class="form-group">
                                ...
                                <span class="text-sm text-danger" id='firstname'></span>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 pb-0">
                            <div class="form-group">
                                ...
                                <span class="text-sm text-danger" id='middlename'></span>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 pb-0">
                            <div class="form-group">
                                ...
                                <span class="text-sm text-danger" id='suffix'></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row pb-0">
                        <div class="col-lg-3 pb-0" style="padding-left : 3px;">
                            <div class="form-group">
                                ...
                                <span class="text-sm text-danger" id="birthdate"></span>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 pb-0">
                            <div class="form-group">
                                ...
                                <span class="text-sm text-danger" id="birthplace"></span>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 pb-0">
                            <div class="form-group">
                                ...
                                <span class="text-sm text-danger" id="gender"></span>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 pb-0">
                            <div class="form-group">
                                ...
                                <span class="text-sm text-danger" id="civil_status"></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <span class="text-sm text-danger" id="address"></span>
                        </div>
                    </div>
                    ...
                    <div class="row pb-0">
                        <div class="col-lg-6 pb-0">
                            ...
                            <span class="text-sm text-danger" id="contact_no"></span>
                        </div>
                        ...
                        <div class="col-lg-6 pb-0">
                            ...
                            <span class="text-sm text-danger" id="active_status"></span>
                        </div>
                    </div>
                    ...
                    <div class="row pb-0">
                        <div class="col-lg-6 pb-0">
                            ...
                            <span class="text-sm text-danger" id="office_charging"></span>
                        </div>
                        <div class="col-lg-6 pb-0">
                            ...
                            <span class="text-sm text-danger" id="office_assignment"></span>
                        </div>
                    </div>
                    ...
                    <div class="row pb-0">
                        <div class="col-lg-6 pb-0">
                            ...
                            <span class="text-sm text-danger" id="position"></span>
                        </div>
                        ...
                        <div class="col-lg-6 pb-0">
                            ...
                            <span class="text-sm text-danger" id="status"></span>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            ...
                            <span class="text-sm text-danger" id="step_increment"></span>
                        </div>

                        <div class="col-lg-4">
                            <label  class="h5 required">SALARY RATE</label>
                            <input name="salary_rate"  class="form-control" />
                            <span class="text-sm text-danger" id="salary_rate"></span>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <span class="text-sm text-danger" id="dbp_account_no"></span>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <span class="text-sm text-danger" id="lbp_account_no"></span>
                                </div>
                            </div>
                        </div>
                    </div>
