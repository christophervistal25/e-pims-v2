<form id="addEmployeeForm">
    <div id="showAddEmployee">
        <div>
            <button class="btn btn-warning shadow-lg h5est text-white mb-2 rounded-circle" type="button"
                    id="btn-add-back">
            ...
            <div class="card shadow-none">
                ...
                <div class="card-body">
                    <img
                        ...
                        class="border border-default float-right p-2 rounded cursor-pointer d-md-none d-lg-block"
                        height="360px"/>
                    ...
                    <div class="row pb-0">
                        <div class="col-lg-12 pb-0">
                            <div class="form-group">
                                ...
                                <input type="number" name="employeeID" radonly value="{{ $lastEmployeeID }}"
                                       class="form-control"/>
                    ...
                    <div class="row pb-0">
                        <div class="col-lg-6 pb-0">
                            ...
                            <select name="office_charging" id="add_form_office_charging"
                        ...
                        <div class="col-lg-6 pb-0">
                            ...
                            <select name="office_assignment" id="add_form_office_assignment"
                                    class="form-control form-select">
                                <option value="">-</option>
                            </select>
                    ...
                    <div class="row pb-0">
                        <div class="col-lg-6 pb-0">
                            ...
                            <select id="add_form_position" name="position" style="width : 100%;"
                                    class="form-control form-select">
                            </select>
                    ...
                    <div class="col-lg-6 pb-0">
                        <div class="form-group">
                            ...
                            <input type="text" name="philhealth_no"
                                   class="form-control  {{ $errors->first('philhealth_no') ? 'is-invalid' : '' }}"
                    ...
                    <div class="col-lg-6 pb-0">
                        <div class="form-group">
                            ...
                            <input type="text" name="pagibig_no"
                                   class="form-control  {{ $errors->has('pagibig_no') ? 'is-invalid' : '' }}"
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="gsis_no"
                                   class="form-control  {{ $errors->has('gsis_no') ? 'is-invalid' : '' }}"
                                   value="{{ old('gsis_no') }}"/>
                        </div>
                    </div>
                </div>
