            ...
            <table class="table table-bordered table-hover text-center" id="salaryAdjustmentPerOffice" style="width:100%;">
                ...
                <tbody>
                    @foreach($salary_adjustment as $key => $salary_adjustments)
                        <tr>
                            <td>{{ Carbon\Carbon::parse($salary_adjustments->date_adjustment)->format('F d, Y' ) }}</td>
                            ...
                            <td>{{ $salary_adjustments->salary_previous }}</td>
                            <td>{{ $salary_adjustments->salary_new }}</td>
                            <td>{{ $salary_adjustments->salary_diff }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
