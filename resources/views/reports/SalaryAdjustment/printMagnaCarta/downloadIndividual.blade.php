        ...
        <div class="col-12 card" id='main-container' style="font-family: 'Open Sans', sans-serif;">
            <div class="card-header" id="headingOne">
                ...
                <div class="card-body-p">
                    ...
                    {{-- BODY --}}
                    <span class="text text-md ml-4 pl-5" style="font-family: 'Open Sans', sans-serif;">&nbsp {{ $setting['Keyvalue1'] }}</span>
                    <br>
                    <br>
                    ...
                    <br><br>
                    <span class="text text-md">Date of Compulsory Retirement as Public Health Worker {{ ($array_retirement_date[$a] == '') ? '' : Carbon\Carbon::parse($array_retirement_date[$a])->format('F d, Y') }}</span>
                    <br><br>
...
<div class="col-12 card" id='main-container' style="font-family: 'Open Sans', sans-serif;">
    <div class="card-header" id="headingOne">
        ...
        <div class="card-body-p">
            ...
            <br><br>
            <span class="text text-md">Date of Compulsory Retirement as Public Health Worker {{ ($salaryAdjustment->retirement_date == '') ? '' : Carbon\Carbon::parse($salaryAdjustment->retirement_date)->format('F d, Y') }}</span>
            {{-- CLOSING, SIGNATURE --}}
            <br><br>
            <div class="text mr-5 float-right" style="font-family: 'Open Sans', sans-serif">
                <p class="mb-5">Very truly yours,</p><br>
