            ...
            <div class="card-header" id="headingOne">
                ...
                <div class="card-body-p">
                    ...
                    <br>
                        ...
                        {{ $array_salary_new[$a] }}{!!$space!!}</span>
                        <br>
                        <span class="text text-md ml-4 pl-5">&nbsp&nbsp&nbsp&nbsp under the new Salary Schedule; SG - {{ $array_sg_no[$a] }}, Step {{ $array_step_no[$a] }}</span>
                        <br>
                        <br>
                        ...
                        <br>
                        <span class="text text-md ml-4 pl-5">&nbsp&nbsp&nbsp&nbsp SG - {{ $array_sg_no[$a] }}, Step {{ $array_step_no[$a] }}</span>
                        <br>
                        <br>
                        ...
                        {{ $array_salary_diff[$a] }}</u>{!!$space!!}</span>
                        <br>
