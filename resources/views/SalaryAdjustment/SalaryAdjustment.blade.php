                         ...
                         <div class="form-group col-12 col-lg-3">
                              <label class="has-float-label mb-0 employeeName" for="employeeName">
                                   <select value="" class="form-control form-control-xs selectpicker" name="employeeName" data-live-search="true" id="employeeName" data-size="5" style="outline: none; box-shadow: 0px 0px 0px transparent;" onchange="clickme()">
                                        ...
                                        <option data-plantilla="{{ $employees }}" value="{{ $employees->Employee->Employee_id }}">
                        ...
                        <input class="form-control" value="" id="officeCode" name="officeCode" type="text" readonly>
                         ...
                         <div class="form-group col-12 col-lg-4">
                              <label class="has-float-label mb-0" for="positionName">
                                   <input class="form-control" value="" name="positionName" id="positionName" type="text" readonly style="outline: none; box-shadow: 0px 0px 0px transparent;">
                         ...
                         <div class="col-lg-4">
                              <div class="form-group input-group mb-0 mt-3">
                                   ...
                                   <label class="has-float-label">
                                        <input class="form-control" value="" name="salaryPrevious" id="salaryPrevious" type="text" readonly style="outline: none; box-shadow: 0px 0px 0px transparent;">
                         ...
                         <div class="col-lg-4">
                              <div class="form-group input-group mb-0 mt-3">
                                   <span class="input-group-text">&#8369;</span>
                                   <label class="has-float-label">
                                        <input class="form-control" value="" name="salaryNew" id="salaryNew" type="text" placeholder="" style="outline: none; box-shadow: 0px 0px 0px transparent;">
                         ...
                         <div class="col-lg-4">
                              <div class="form-group input-group mb-0 mt-3">
                                   <span class="input-group-text">&#8369;</span>
                                   <label class="has-float-label">
                                        <input class="form-control" value="" name="salaryDifference" id="salaryDifference" type="text" readonly style="outline: none; box-shadow: 0px 0px 0px transparent;">
