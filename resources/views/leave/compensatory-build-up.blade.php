            ...
            <div>
                ...
                <div class="page-header">
                    ...
                    <div class="table-responsive">
                        <table class="table table-condensed responsive display nowrap" id="compensatoryleaves"
                            style="width:100%;">
                            <thead>
                                <tr>
                            ...
                            <div class="row">
                                <div class="col-lg-12 text-center">
                                    <img class="mb-5 rounded-circle img-thumbnail" id="empPhoto"
                                        src="/storage/employee_images/no-image.png" width="50%" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <label for="totalComBal" class="form-group has-float-label">
                                        <input type="text" name="totalComBal" id="totalComBal" class="form-control"
                                            value="0"
                                            style="outline: none; box-shadow: 0px 0px 0px transparent; height: 180px; font-size:100px; text-align:center; background: white;"
                                            readonly>
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-9">
                            <div class="card shadow">
                                <div class="card-body">
                                    <div class="alert alert-warning mb-0">
                                        <div class="row">
                                            <div class="col-lg-12 text-center font-weight-bold mt-2">
                                    ...
                                    <div class="row mt-3 forfeited">
                                        <div class="col-lg-3">
                                                <label for="officelist" class="form-group has-float-label year_filter">
                                                    <select class="form-control selectpicker" name="year_filter" id="year_filter">
                                                        @foreach($yearfilters as $yearfilter)
                                                        <option value="{{ $yearfilter }}"
                                                            {{ $yearfilter == date('Y') ? 'selected' : '' }}>
                                                            {{ $yearfilter }} </option>
                                                        @endforeach
                                                    </select>
                                        ...
                                        <div class="col-lg-3 text-right">
                                            <div class="form-check form-check-inline">
                                                ...
                                                <input class="form-check-input" name="forfeited" type="checkbox"
                                                    id="forfeited">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="table-responsive tableFixHead" style="height :50vh;">
                                        <img class="mt-5 w-100" id="selectEmployee"
                                            src="{{ asset('/assets/img/selectEmployee.png') }}" />
                                        <table class="table table-condensed text-center" id="compensatory-leave-table"
                                            width="100%">
                                            <thead>
                                                <tr>
                                                    <th class="font-weight-bold align-middle text-center">Date Added
                                                    </th>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <h4 class="text-danger">
                                                <strong>Note:</strong><small> Unused earned
                                                    compensatory leave will automatically be forfeited by January of the
                                                    next year.</small> 
                                            </h4>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-3 pr-1 pl-1">
                                    <button type="button"
                                        class="text-white shadow btn btn-lg btn-success btn-block mt-1" id="btnEarn"><i
                                            class="la la-plus-circle"></i> Earn Compensatory</button>
                                </div>
                                <div class="col-md-3 pr-1 pl-1">
                                    <button type="button" class="text-white shadow btn btn-lg btn-info btn-block mt-1"
                                        id="btnAvail"><i class="la la-cart-arrow-down"></i> Avail Compensatory</button>
                                </div>
                                <div class="col-md-3">
                                </div>
                                <div class="col-md-3">
                                    <button type="button"
                                        class="text-white shadow btn btn-lg btn-primary btn-block mt-1" id="btnBack"><i
                                            class="la la-list"></i>
                                        Go back to List
                                    </button>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <label for="hours_rendered" class="form-group has-float-label hours_rendered">
                                <input type="number" name="hours_rendered" id="hours_rendered"
                                    class="form-control hours_rendered" value="0"
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <label for="remarks" class="form-group has-float-label">
                                <textarea id="remarks" name="remarks" rows="6" class="w-100 form-control remarks"
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input type="hidden" class='form-control' name="edit_totalComBalance"
                                    id="edit_totalComBalance">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <label for="edit_hours_rendered" class="form-group has-float-label edit_hours_rendered">
                                <input type="number" name="edit_hours_rendered" id="edit_hours_rendered"
                                    class="form-control edit_hours_rendered" value="0"
                                    style="outline: none; box-shadow: 0px 0px 0px transparent; height: 100px; font-size:75px; font-family:Century Gothic; text-align:right; ">
                                <span class="font-weight-bold">HOURS RENDERED<span class='text-danger'>*</span></span>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <label for="edit_availed" class="form-group has-float-label edit_availed">
                                <input type="number" name="edit_availed" id="edit_availed"
                                    class="form-control edit_availed" value="0"
                                    style="outline: none; box-shadow: 0px 0px 0px transparent; height: 100px; font-size:75px; font-family:Century Gothic; text-align:right; ">
                                <span class="font-weight-bold">Availment(hours)<span class='text-danger'>*</span></span>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <label for="edit_remarks" class="form-group has-float-label">
                                <textarea id="edit_remarks" name="edit_remarks" rows="6"
                                    class="w-100 form-control edit_remarks"
                                    placeholder="Write your remarks here"></textarea>
                                <span class="font-weight-bold">REMARKS <span class='text-danger'>*</span></span>
