            ...
            <div class="card-header" id="headingOne" contenteditable="true">
                ...
                <div class="body-container row">
                    ...
                    <div class="header-text w-25 logo">
                        <img src="file:///laragon/www/E-PIMS-V2/public/assets/img/sdslogo.jpg" width="100px">
                    </div>
                ...
                <div class="card-body-p">
                    ...
                    <br>
                    <br>
                    <span class="text d-flex">This Step Increment is subject for review and post-audit by the Department
                    ...
                    {{-- FOOTER --}}
                    <div class="float-left" style="margin-top: 150px">
