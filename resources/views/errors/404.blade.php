...
<body>
    <center>
        <img  src="{{ asset('assets/img/main-logo.png') }}" alt="" width="300">
        <h1 style="font-size : 8vw; text-shadow : 0px 8px 3px #F1F2F6;">404</h1>
        <h1 style="font-weight : 500; letter-spacing : 2px; ">PAGE NOT FOUND</h1>
    </center>
</body>
</html>
