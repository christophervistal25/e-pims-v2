                ...
                <div class="container">
                    <div class="row justify-content-center align-items-center">
                        ...
                        <div class="form-group col-12 col-md-6 col-lg-7">
                            ...
                            <input value="{{ old('positionCode') ?? $position->position_code}}"
                        ...
                        <div class="form-group col-12 col-md-6 col-lg-7">
                            <label class="has-float-label mb-0">
                            <input value="{{ old('positionName') ?? $position->position_name }}"
                        ...
                        <div class="form-group col-12 col-lg-7">
                            <label class="has-float-label mb-0">
                            <input value="{{ old('positionShortName') ?? $position->position_short_name}}"
