    ...
    <div class="kanban-board card shadow-none">
        <div class="card-body">
            <div id="add" class="page-header {{  count($errors->all())  !== 0 ?  '' : 'd-none' }}">
                <div style='padding-bottom:50px;margin-right:-15px;' class="col-auto ml-auto">
                    <button id="showListPosition" class="btn btn-primarys submit-btn float-right shadow"><i
                            class="fa fa-list"></i> Position List
                    </button>
                </div>
                            ...
                            <div class="form-group col-12 col-md-6 col-lg-7">
                                <label class="has-float-label mb-0">
                                    <input value="{{ old('positionCode') ?? $lastId->position_code + 1}}"
                                           ...
                                           name="positionCode"
                                           id="positionCode" type="text" placeholder=""
                                           style="outline: none; box-shadow: 0px 0px 0px transparent;">
                                    <span class="font-weight-bold">Position Code<span
                            ...
                            <div class="form-group col-10 col-lg-7">
                                <label class="has-float-label salaryGradeNo mb-0">
                                    <select value=""
                                            ...
                                            name="salaryGradeNo" data-live-search="true" id="salaryGradeNo"
                                            data-size="4"
                                            data-width="100%"
                                            style="outline: none; box-shadow: 0px 0px 0px transparent;">
                                        <option></option>
                                        @foreach (range(1, 33) as $sg)
                                            <option
                                                {{ old('stepNo') == $sg ? 'selected' : '' }} value="{{ $sg}}">{{ $sg}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group col-12 col-lg-7">
                                <label class="has-float-label mb-0">
                                    <input value="{{ old('positionShortName') }}"
                                           ...
                                           name="positionShortName" id="positionShortName" type="text"
                                           style="outline: none; box-shadow: 0px 0px 0px transparent;">
            ...
            <div id="table" class="page-header {{  count($errors->all()) == 0 ? '' : 'd-none' }}">
                ...
                <div>
                    <table class="table table-bordered table-hover text-center" id="maintenancePosition"
                           style="width:100%;">
                        <thead>
                        <tr>
