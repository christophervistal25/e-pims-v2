...
<div class="card">
    <div class="card-body">
        <ul class="nav nav-tabs nav-tabs-solid nav-justified">
            ...
            <li class="nav-item"><a class="nav-link active" href="#c2-tab" data-toggle="tab">C2</a></li>
        ...
        <div class="tab-content">
            ...
            {{-- END OF C1 --}}
            <div class="tab-pane show active" id="c2-tab">
                ...
                <div id="accordion">
                    ...
                    <div class="card">
                      ...
                      <div id="workExperience" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                        <div class="card-body">
...
<script>
    ...
    // This will add new table row for civil service
    ...
    // Add new table row for work experience
