    ...
    <div class="card-body">
        <div id="add" class="page-header {{  count($errors->all())  !== 0 ?  '' : 'd-none' }}">
            <div style='padding-bottom:50px;margin-right:-15px;' class="col-auto ml-auto">
                <button id="showListOffice" class="btn btn-primarys submit-btn float-right shadow"><i class="fa fa-list"></i> Office List</button>
            </div>
                    ...
                    <div class="row justify-content-center align-items-center">
                        ...
                        <div class="form-group col-12 col-md-12 col-lg-7">
                            <label class="has-float-label mb-0">
                                <input value="{{ old('officeName') }}" class="form-control {{ $errors->has('officeName')  ? 'is-invalid' : ''}}" name="officeName" id="officeName" type="text" style="outline: none; box-shadow: 0px 0px 0px transparent;">
                        ...
                        <div class="form-group col-7 col-lg-7">
                            <label class="has-float-label mb-0">
                                <input value="{{ old('officeShortName') }}" class="form-control {{ $errors->has('officeShortName')  ? 'is-invalid' : ''}}" name="officeShortName" id="officeShortName" type="text" style="outline: none; box-shadow: 0px 0px 0px transparent;">
                        ...
                        <div class="form-group col-12 col-lg-7">
                            <label class="has-float-label mb-0">
                                <input value="{{ old('officeAddress') }}" class="form-control {{ $errors->has('officeAddress')  ? 'is-invalid' : ''}}" name="officeAddress" id="officeAddress" type="text" style="outline: none; box-shadow: 0px 0px 0px transparent;">
                        ...
                        <div class="form-group col-12 col-lg-7">
                            <label class="has-float-label mb-0">
                                <input value="{{ old('officeShortAddress') }}" class="form-control {{ $errors->has('officeShortAddress')  ? 'is-invalid' : ''}}" name="officeShortAddress" id="officeShortAddress" type="text" style="outline: none; box-shadow: 0px 0px 0px transparent;">
                        ...
                        <div class="form-group col-12 col-lg-7">
                            <label class="has-float-label mb-0">
                                <input value="{{ old('officeHead') }}" class="form-control {{ $errors->has('officeHead')  ? 'is-invalid' : ''}}" name="officeHead" id="officeHead" type="text" style="outline: none; box-shadow: 0px 0px 0px transparent;">
        ...
        <div id="table" class="page-header {{  count($errors->all()) == 0 ? '' : 'd-none' }}">
            ...
            <div class="table">
                <table class="table table-bordered table-hover text-center" id="maintenanceOffice" style="width:100%;">
                    <thead>
                        <tr>
                            <td class="text-center text-uppercase h6">Code</td>
                            <td class="text-center text-uppercase h6">Name</td>
