    ...
    <div class="card-body">
        <div id="add" class="page-header {{  count($errors->all())  !== 0 ?  '' : 'd-none' }}">
            <div style='padding-bottom:50px;margin-right:-15px;' class="col-auto ml-auto">
                <button id="showListDivision" class="btn btn-primarys submit-btn float-right shadow"><i
                        ...
                        <div class="form-group col-12 col-md-6 col-lg-7">
                            <label class="has-float-label mb-0">
                                <input value="{{ old('divisionName') }}"
                                    ...
                                    name="divisionName" id="divisionName" type="text" style="outline: none; box-shadow: 0px 0px 0px transparent;">
                        ...
                        <div class="form-group col-10 col-lg-7">
                            <label class="has-float-label officeCode mb-0">
                                <select value=""
                                    ...
                                    <option {{ old('officeCode') == $office->office_code ? 'selected' : '' }}
        ...
        <div id="table" class="page-header {{  count($errors->all()) == 0 ? '' : 'd-none' }}">
            <div class="row">
                <div class="col-5 mb-2">
                    <select value="" data-style="btn-primarys text-white"
                        class="form-control form-control-xs selectpicker {{ $errors->has('employeeOffice')  ? 'is-invalid' : ''}}"
                        name="maintenanceDivisionOffice" data-live-search="true" id="maintenanceDivisionOffice"
                        data-size="5">
            ...
            <div class="table">
                <table class="table table-bordered table-hover text-center" id="maintenanceDivision"
                    style="width:100%;">
                    <thead>
                        <tr>
