...
<div class="kanban-board card shadow mb-0">
    <div class="card-body">
        <div id="add" class="page-header">
            <form action="{{ route('maintenance-division.update', $division->division_id) }}" method="post" id="maintenanceDivisionEditForm">
                @csrf
                @method('PUT')
                    ...
                    <div class="row justify-content-center align-items-center">
                        ...
                        <div class="form-group col-10 col-lg-7">
                            ...
                            <select value=""
                                ...
                                <option {{ $division->office_code == $offices->office_code ? 'selected' : '' }} value="{{ $offices->office_code}}">
