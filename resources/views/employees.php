					...
					<div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
						<div class="profile-widget">
							<div class="profile-img">
								<a href="profile.php?id=<?php echo($row['id']); ?>" class="avatar"><img src="uploads/employees/<?php echo htmlentities($row['Picture']); ?>" alt="picture"></a>
							</div>
							...
							<h4 class="user-name m-t-10 mb-0 text-ellipsis"><a href="profile.php?id=<?php echo($row->id); ?>"><?php echo htmlentities($row['FirstName'])." ".htmlentities($row['LastName']); ?></a></h4>
