            ...
            <div class="card-body">
                ...
                <div id="add" class="page-header {{  count($errors->all())  !== 0 ?  '' : 'd-none' }}">
                    <div style='padding-bottom:50px;margin-right:-15px;' class="col-auto ml-auto">
                        <button id="showList" class="btn btn-primarys submit-btn float-right shadow"><i
                                class="fa fa-list"></i>
                            Salary Grade List
                        </button>
                    </div>
                    ...
                    <form action="" method="POST" id="salaryGradeForm">
                            ...
                            <label class="has-float-label sgNo mb-0">
                                <select value=""
                                    ...
                                    @foreach (range(1, 33) as $salarygrade)
                                        <option
                                            {{ old('sgNo') == $salarygrade ? 'selected' : '' }} value="{{ $salarygrade }}">
                                            {{ $salarygrade }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-12 col-md-4">
                                <div class="form-group input-group col-12 mb-0 mt-2">
                                    ...
                                    <label class="has-float-label" for="sgStep1">
                                        <input class="form-control text-right" value="{{ old('sgStep1') }}" id="sgStep1"
                            ...
                            <div class="col-12 col-md-4">
                                <div class="form-group input-group col-12 mb-0 mt-2">
                                    ...
                                    <label class="has-float-label" for="sgStep2">
                                        <input class="form-control text-right" value="{{ old('sgStep2') }}" id="sgStep2"
                            ...
                            <div class="col-12 col-md-4">
                                <div class="form-group input-group col-12 mb-0 mt-2">
                                    ...
                                    <label class="has-float-label" for="sgStep3">
                                        <input class="form-control text-right" value="{{ old('sgStep3') }}" id="sgStep3"
                                ...
                                <div class="form-group input-group col-12 mb-0 mt-3">
                                    ...
                                    <label class="has-float-label" for="sgStep4">
                                        <input style="outline: none; box-shadow: 0px 0px 0px transparent;"
                                               ...
                                               value="{{ old('sgStep4') }}" id="sgStep4" name="sgStep4" type="text"
                                               maxlength="12">
                            ...
                            <div class="col-12 col-md-4">
                                <div class="form-group input-group col-12 mb-0 mt-3">
                                    ...
                                    <label class="has-float-label" for="sgStep5">
                                        <input class="form-control text-right" value="{{ old('sgStep5') }}" id="sgStep5"
                            ...
                            <div class="col-12 col-md-4">
                                <div class="form-group input-group col-12 mb-0 mt-3">
                                    ...
                                    <label class="has-float-label" for="sgStep6">
                                        <input class="form-control text-right" value="{{ old('sgStep6') }}" id="sgStep6"
                                               name="sgStep6"
                                               style="outline: none; box-shadow: 0px 0px 0px transparent;"
                            ...
                            <div class="col-12 col-md-4">
                                <div class="form-group input-group col-12 mb-0 mt-3">
                                    ...
                                    <label class="has-float-label" for="sgStep7">
                                        <input class="form-control text-right" value="{{ old('sgStep7') }}" id="sgStep7"
                                               style="outline: none; box-shadow: 0px 0px 0px transparent;"
                                               name="sgStep7"
                                               type="text" maxlength="12">
                            ...
                            <div class="col-12 col-md-4">
                                <div class="form-group input-group col-12 mb-0 mt-3">
                                    ...
                                    <label class="has-float-label">
                                        ...
                                        <input class="form-control text-right" value="{{ old('sgStep8') }}" id="sgStep8"
                                               style="outline: none; box-shadow: 0px 0px 0px transparent;"
                                               name="sgStep8"
                                               type="text" maxlength="12">
                                    </label>
                        ...
                        <div class="form-group col-12 col-lg-4 mt-4">
                            <label class="has-float-label sgYear mb-0">
                                <select value=""
                                    ...
                                    <option
                                        {{ old('sgYear') == $year2 ? 'selected' : '' }} value={{ $year2 }}>{{ $year2 }}
                                    </option>
                                    {{ $year3 = date("Y",strtotime("-0 year")) }}
                                    <option
                                        {{ old('sgYear') == $year3 ? 'selected' : '' }} value={{ $year3 }}>{{ $year3 }}
                                    </option>
                                    @foreach (range(1, 5) as $year)
                                        {{ $year1 = date("Y",strtotime("$year year")) }}
                                        <option
                                            {{ old('sgYear') == $year1 ? 'selected' : '' }} value={{ $year1 }}>{{ $year1 }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group submit-section col-12">
                            <button id="saveBtn" class="btn btn-primarys submit-btn float-right shadow"
                                    type="submit"><span id="loading" class="spinner-border spinner-border-sm d-none"
                                                        role="status"
                                                        aria-hidden="false"></span> <i class="fas fa-save"></i>
                                <b id="saving">Save</b>
                            </button>
                            <button style="margin-right:10px;" type="button" id="cancelButton"
                                    class="btn text-white btn-danger submit-btn float-right shadow"><i
                ...
                <div id="table" class="page-header {{  count($errors->all()) == 0 ? '' : 'd-none' }}">
                    ...
                    <div class="table">
                        <table width="100%" cellspacing="0" class="table table-bordered table-hover text-center"
                               id="salaryGradeTable">
                            <thead>
                            <tr>
