      ...
      <div class="card-body">
            ...
            <div id="add" class="page-header {{  count($errors->all())  !== 0 ?  '' : 'd-none' }}">
                  <div style='padding-bottom:50px;'>
                        <button id="showListPlantillaPosition" class="btn btn-primarys submit-btn float-right shadow"><i class="fa fa-list"></i> Position List</button>
                  </div>
                                    ...
                                    <div class="row">
                                          ...
                                          <div class=" col-6 col-md-6 col-lg-6">
                                                <label class="has-float-label officeCode mb-0">
                                                      <select value="" class="form-control selectpicker" name="officeCode" data-live-search="true" id="officeCode" data-size="4" data-width="100%" style="outline: none; box-shadow: 0px 0px 0px transparent;">
                                                            <option></option>
                                          ...
                                          <div class=" col-6 col-md-6 col-lg-6">
                                                <label class="has-float-label mb-0">
                                                      <input value="{{ old('itemNo') }}" class="form-control {{ $errors->has('itemNo')  ? 'is-invalid' : ''}}" name="itemNo" id="itemNo" type="number" placeholder="" style="outline: none; box-shadow: 0px 0px 0px transparent;">
                                            ...
                                            <label class="has-float-label divisionId mb-0">
                                                  <select value="" class="form-control form-control-xs selectpicker" name="divisionId" data-live-search="true" id="divisionId" data-size="4" data-width="100%" style="outline: none; box-shadow: 0px 0px 0px transparent;">
                                                        ...
                                                        @foreach($division as $divisions)
                                                            <option style="width:350px;" {{ old('divisionId') == $divisions->division_id ? 'selected' : '' }} value="{{ $divisions->division_id }}">{{ $divisions->division_name }} - {{ $divisions->offices->office_name }}</option>
                                                        @endforeach
                                                  </select>
                                      ...
                                      <div class="col-5 col-lg-6">
                                        ...
                                        <div id='section-error-message' class='text-danger text-sm'>
                                          ...
                                          <div class="col-5 col-lg-5">
                                                <label class="has-float-label positionTitle mb-0">
                                                      <select value="" class="form-control form-control-xs selectpicker" name="positionTitle" data-live-search="true" id="positionTitle" data-size="4" data-width="100%" style="outline: none; box-shadow: 0px 0px 0px transparent;">
                                                            ...
                                                            <option data-position="{{ $positions }}" style="width:350px;" {{ old('positionTitle') == $positions->PosCode ? 'selected' : '' }} value="{{ $positions->PosCode}}">{{ $positions->Description }}</option>
                                                            @endforeach
                                                      </select>
                                                      ...
                                                      <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                  ...
                                                                  <div class=" col-12 col-md-6 col-lg-12">
                                                                        <label class="has-float-label mb-0">
                                                                              <input value="{{ old('addPositionCode') ?? $lastId->PosCode + 1 }}" class="form-control {{ $errors->has('addPositionCode')  ? 'is-invalid' : ''}}" name="addPositionCode" id="addPositionCode" type="text" placeholder="" style="outline: none; box-shadow: 0px 0px 0px transparent;">
                                                                  ...
                                                                  <div class=" col-12 col-md-6 col-lg-12">
                                                                        <label class="has-float-label mb-0">
                                                                              <input value="{{ old('addPositionName') }}" class="form-control {{ $errors->has('addPositionName')  ? 'is-invalid' : ''}}" name="addPositionName" id="addPositionName" type="text" placeholder="" style="outline: none; box-shadow: 0px 0px 0px transparent;">
                                          ...
                                          <div class="col-6 col-md-6 col-lg-6">
                                                <label class="has-float-label mb-0">
                                                      <input value="{{ old('positionOldName') }}" class="form-control" name="positionOldName" id="positionOldName" type="text" style="outline: none; box-shadow: 0px 0px 0px transparent;">
                                          ...
                                          <div class=" col-6 col-md-6 col-lg-6">
                                                <label class="has-float-label salaryGrade mb-0">
                                                      <select value="" class="form-control selectpicker" name="salaryGrade" data-live-search="true" id="salaryGrade" data-size="4" data-width="100%" style="outline: none; box-shadow: 0px 0px 0px transparent;">
                                                            <option></option>
                                                            @foreach (range(1 , 33) as $salarygrades)
