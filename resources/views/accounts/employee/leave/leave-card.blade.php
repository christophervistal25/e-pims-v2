        ...
        <div class="col-lg-12 align-middle">
            <div class="welcome-box">
                ...
                <div class="welcome-det">
                    <h4 id="employee__fullname">{{ $employee->fullname }}</h4>
                        ...
                        <table class="table table-bordered table-hover" id="leave-card-table">
                            <thead>
                                <tr>
                                    ...
                                    <th colspan="4" class='text-center align-middle font-weight-bold'>VACATION LEAVE</th>
                                    <th colspan="4" class='text-center align-middle font-weight-bold'>SICK LEAVE</th>
                                    {{-- <th colspan="2" rowspan="2" class='text-center align-middle font-weight-bold'>BALANCE</th> --}}
                                </tr>
                                <tr>
                            ...
                            <tbody id='leave-card-body'>
                                    ...
                                    @if($forwardedBalance->count() != 0)
                                        <tr>                                                              
                                            <td class='text-truncate align-middle'>{{ Carbon\Carbon::parse($forwardedVacationLeave->fb_as_of)->format('M. Y') }}</td>
                                            <td class='text-truncate text-center bg-light'>ENTRANCE</td>
                                            <td class='text-truncate text-center'></td>
                                            <td class='text-truncate text-center'></td>
                                            <td class='text-truncate text-center bg-light font-weight-bold' data-label="vacation_balance">{{ number_format($forwardedVacationLeave->earned - $forwardedVacationLeave->used, 3, '.', '') }}</td>
                                            <td class='text-truncate text-center'></td>

                                            {{-- SICK LEAVE --}}
                                            <td class='text-truncate text-center'</td>
                                            <td class='text-truncate text-center'></td>
                                            <td class='text-truncate text-center bg-light font-weight-bold'>{{ number_format($forwardedSickLeave->earned - $forwardedSickLeave->used, 3, '.', '') }}</td>
                                            <td class='text-truncate text-center'></td>

                                            {{-- TOTAL --}}
                                            <td class='text-truncate text-center bg-light font-weight-bold'>{{ number_format(($forwardedVacationLeave->earned - $forwardedVacationLeave->used) + ($forwardedSickLeave->earned - $forwardedSickLeave->used), 3, '.', '') }}</td>
                                        </tr>
                                    @endif
                                    ...
                                    @endphp
                                        ...
                                        @if($type == $TYPES['INCREMENT'])
                                            <tr>
                                                {{-- VACATION LEAVE DATA --}}
                                                <td class='text-truncate align-middle'>{{ $record[0]->date_record->format('M. Y') }}</td>
                                                <td class='text-truncate text-center align-middle bg-light'>{{ $record[0]->particular }}</td>
                                                <td class='text-truncate text-center align-middle bg-light font-weight-bold'>{{ $record[0]->earned }}</td>
                                                <td class='text-truncate text-center align-middle'></td>
                                                <td class='text-truncate text-center align-middle bg-light font-weight-bold'>{{ $forwardedVacationLeave->earned += $record[0]->earned }}</td>
                                                <td class='text-truncate text-center align-middle'></td>


                                                {{-- SICK LEAVE DATA --}}
                                                <td class='text-truncate text-center align-middle bg-light font-weight-bold'>{{ $record[1]->earned }}</td>
                                                <td class='text-truncate text-center align-middle'></td>
                                                <td class='text-truncate text-center align-middle bg-light font-weight-bold'>{{ $forwardedSickLeave->earned += $record[1]->earned }}</td>
                                                <td></td>

                                                <td class='text-truncate text-center align-middle bg-light font-weight-bold'>{{ ($forwardedVacationLeave->earned + $forwardedSickLeave->earned) }}</td>
                                            </tr>
                                            ...
                                            @foreach($record as $data)
                                                @if(!is_null($data->leave_application_id))
                                                    <tr>
                                                        ...
                                                        <td class='text-truncate align-middle'>
                                                            {{ $data->date_record->format('M. d') }} - {{ $data->leave_file_application->date_to->format('M. d, Y') }}
                                                        </td>
                                                        ...
                                                        @if($data->type->code_number === $VACATION_LEAVE_CODE_NUMBER)
                                                            <td class='text-truncate text-center font-weight-bold' data-label="vacation_absences_under_time_with_pay">{{ $data->used }}</td>
                                                            <td class='text-truncate text-center bg-light font-weight-bold' data-label="">{{ number_format($forwardedVacationLeave->earned -= $data->used, 3, '.', '') }}</td>
                                                            @else
                                                            <td class="text-truncate text-center"></td>
                                                        ...
                                                        @if($data->type->code_number === $SICK_LEAVE_CODE_NUMBER)
                                                            <td class='text-truncate text-center bg-light font-weight-bold'>{{ $data->used }}</td>
                                                            <td class='text-truncate text-center bg-light font-weight-bold' data-label="">{{ number_format($forwardedSickLeave->earned -= $data->used, 3, '.', '')  }}</td>
                                                            @else
                                                            <td></td>
                                                        ...
                                                        <td class='text-truncate text-center bg-light font-weight-bold'>{{ number_format($forwardedVacationLeave->earned + $forwardedSickLeave->earned, 3, '.', '') }}</td>
                                                    </tr>
                                                @elseif(!is_null($data->undertime_id))
                                                    <tr>
                                                        ...
                                                        <td class='text-truncate text-center' data-label="vacation_earned"></td>
                                                        @if($data->type->code_number === $VACATION_LEAVE_CODE_NUMBER)
                                                            <td class='text-truncate text-center font-weight-bold bg-light'>{{ $data->undertime->equivalent }}</td>
                                                            <td class='text-truncate text-center bg-light font-weight-bold'>{{ number_format($forwardedVacationLeave->earned -= $data->undertime->equivalent, 3, '.', '') }}</td>
                                                            @else
                                                            <td></td>
                                                        ...
                                                        @if($data->type->code_number === $SICK_LEAVE_CODE_NUMBER)
                                                            <td class='text-truncate text-center font-weight-bold bg-light'>{{ $data->undertime->equivalent }}</td>
                                                            <td class='text-truncate text-center bg-light'>{{ number_format($forwardedSickLeave->earned -= $data->undertime->equivalent, 3, '.', '') }}</td>
                                                            @else
                                                            <td></td>
