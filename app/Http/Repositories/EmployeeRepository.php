...
class EmployeeRepository
{
      ...
      public function existingEmployeeAddEducationalBackground(array $data = []): array
      {
            ...
            $employeeEducationalBackground->elementary_name                                    = $data['elementary_name'];
            $employeeEducationalBackground->elementary_education                               = $data['elementary_education'];
            $employeeEducationalBackground->elementary_period_from                             = $data['elementary_period_from'];
            $employeeEducationalBackground->elementary_period_to                               = $data['elementary_period_to'];
            $employeeEducationalBackground->elementary_highest_level_units_earned              = $data['elementary_highest_level_units_earned'];
            $employeeEducationalBackground->elementary_year_graduated                          = $data['elementary_year_graduated'];
            $employeeEducationalBackground->elementary_scholarship                             = $data['elementary_scholarship'];
            $employeeEducationalBackground->secondary_name                                     = $data['secondary_name'];
            $employeeEducationalBackground->secondary_education                                = $data['secondary_education'];
            $employeeEducationalBackground->secondary_period_from                              = $data['secondary_period_from'];
            $employeeEducationalBackground->secondary_period_to                                = $data['secondary_period_to'];
            $employeeEducationalBackground->secondary_highest_level_units_earned               = $data['secondary_highest_level_units_earned'];
            $employeeEducationalBackground->secondary_year_graduated                           = $data['secondary_year_graduated'];
            $employeeEducationalBackground->secondary_scholarship                              = $data['secondary_scholarship'];
            $employeeEducationalBackground->vocational_trade_course_name                       = $data['vocational_trade_course_name'];
            $employeeEducationalBackground->vocational_education                               = $data['vocational_education'];
            $employeeEducationalBackground->vocational_trade_course_period_from                = $data['vocational_trade_course_period_from'];
            $employeeEducationalBackground->vocational_trade_course_period_to                  = $data['vocational_trade_course_period_to'];
            $employeeEducationalBackground->vocational_trade_course_highest_level_units_earned = $data['vocational_trade_course_highest_level_units_earned'];
            $employeeEducationalBackground->vocational_trade_course_year_graduated             = $data['vocational_trade_course_year_graduated'];
            $employeeEducationalBackground->vocational_trade_course_scholarship                = $data['vocational_trade_course_scholarship'];
            $employeeEducationalBackground->college_name                                       = $data['college_name'];
            $employeeEducationalBackground->college_education                                  = $data['college_education'];
            $employeeEducationalBackground->college_period_from                                = $data['college_period_from'];
            $employeeEducationalBackground->college_period_to                                  = $data['college_period_to'];
            $employeeEducationalBackground->college_highest_level_units_earned                 = $data['college_highest_level_units_earned'];
            $employeeEducationalBackground->college_year_graduated                             = $data['college_year_graduated'];
            $employeeEducationalBackground->college_scholarship                                = $data['college_scholarship'];
            $employeeEducationalBackground->graduate_studies_name                              = $data['graduate_studies_name'];
            $employeeEducationalBackground->graduate_studies_education                         = $data['graduate_studies_education'];
            $employeeEducationalBackground->graduate_studies_period_from                       = $data['graduate_studies_period_from'];
            $employeeEducationalBackground->graduate_studies_period_to                         = $data['graduate_studies_period_to'];
            $employeeEducationalBackground->graduate_studies_highest_level_units_earned        = $data['graduate_studies_highest_level_units_earned'];
            $employeeEducationalBackground->graduate_studies_year_graduated                    = $data['graduate_studies_year_graduated'];
            $employeeEducationalBackground->graduate_studies_scholarship                       = $data['graduate_studies_scholarship'];
            $employee->educational_background()->save($employeeEducationalBackground);
            return $data;
      }
